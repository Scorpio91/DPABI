...
%scorpio91, 20190319. the calling of Cfg.ParallerWorkersNumber errored once load previously autosaved .mat files (in which no paraller workers were defined)
% PCTVer = ver('distcomp');
% if ~isempty(PCTVer)
